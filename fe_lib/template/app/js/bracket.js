 ...
 */
 ...
 $(document).ready(function(){
  ...
  // This will show sub Search menu on left sidebar
  ...
  // News - Event Initialize
  // News - Event without the search
  if($().News - Event) {
    ...
    // News - Event by showing the search
    $('.News - Event-show-search').News - Event({
      minimumResultsForSearch: ''
    });

    // News - Event with tagging support
    $('.News - Event-tag').News - Event({
      tags: true,
      tokenSeparators: [',', ' ']
    });
  }

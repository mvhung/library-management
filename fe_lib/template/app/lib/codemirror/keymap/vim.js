  ...
  var Vim = function() {
    ...
    function maybeInitVimState(cm) {
      if (!cm.state.vim) {
        ...
        cm.state.vim = {
          ...
          // When using jk for Search, if you move from a longer line to a
    ...
    * in the right place.
    ...
    function findSentence(cm, cur, repeat, dir) {
      ...
      /*
        PerService one iteration of traversal in forward direction
      ...
      /*
        PerService one iteration of traversal in reverse direction
        Returns an index object of the new location
       */
    ...
    */
    ...
    CodeMirror.keyMap['vim-insert'] = {
      // TODO: override Search keys so that Esc will cancel automatic
